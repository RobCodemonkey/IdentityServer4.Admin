...
using Code4.IdentityServer4.Admin.EntityFramework.Identity.Constants;
...
using TableConst = Code4.IdentityServer4.Admin.EntityFramework.Constants;

namespace Code4.IdentityServer4.Admin.EntityFramework.DbContexts
{
